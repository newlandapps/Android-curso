...
public class com_newlandapps_onroad_z_version2_MenuFragments_Units_model_UnitFinalRealmProxy extends com.newlandapps.onroad.z_version2.MenuFragments.Units.model.UnitFinal
    implements RealmObjectProxy, com_newlandapps_onroad_z_version2_MenuFragments_Units_model_UnitFinalRealmProxyInterface {

    static final class UnitFinalColumnInfo extends ColumnInfo {
        ...
        UnitFinalColumnInfo(OsSchemaInfo schemaInfo) {
            super(21);
            OsObjectSchemaInfo objectSchemaInfo = schemaInfo.getObjectSchemaInfo("UnitFinal");
        ...
        UnitFinalColumnInfo(ColumnInfo src, boolean mutable) {
            super(src, mutable);
            copy(src, this);
        }
        ...
        protected final ColumnInfo copy(boolean mutable) {
            return new UnitFinalColumnInfo(this, mutable);
        }

        @Override
        protected final void copy(ColumnInfo rawSrc, ColumnInfo rawDst) {
            final UnitFinalColumnInfo src = (UnitFinalColumnInfo) rawSrc;
            final UnitFinalColumnInfo dst = (UnitFinalColumnInfo) rawDst;
    ...
    private UnitFinalColumnInfo columnInfo;
    private ProxyState<com.newlandapps.onroad.z_version2.MenuFragments.Units.model.UnitFinal> proxyState;
    ...
    public void realm$injectObjectContext() {
        ...
        this.columnInfo = (UnitFinalColumnInfo) context.getColumnInfo();
        this.proxyState = new ProxyState<com.newlandapps.onroad.z_version2.MenuFragments.Units.model.UnitFinal>(this);
    ...
    private static OsObjectSchemaInfo createExpectedObjectSchemaInfo() {
        OsObjectSchemaInfo.Builder builder = new OsObjectSchemaInfo.Builder("UnitFinal", 21, 0);
    ...
    public static UnitFinalColumnInfo createColumnInfo(OsSchemaInfo schemaInfo) {
        return new UnitFinalColumnInfo(schemaInfo);
    }
    ...
    public static final class ClassNameHelper {
        public static final String INTERNAL_CLASS_NAME = "UnitFinal";
    }

    @SuppressWarnings("cast")
    public static com.newlandapps.onroad.z_version2.MenuFragments.Units.model.UnitFinal createOrUpdateUsingJsonObject(Realm realm, JSONObject json, boolean update)
        throws JSONException {
        final List<String> excludeFields = Collections.<String> emptyList();
        com.newlandapps.onroad.z_version2.MenuFragments.Units.model.UnitFinal obj = null;
        if (update) {
            Table table = realm.getTable(com.newlandapps.onroad.z_version2.MenuFragments.Units.model.UnitFinal.class);
            UnitFinalColumnInfo columnInfo = (UnitFinalColumnInfo) realm.getSchema().getColumnInfo(com.newlandapps.onroad.z_version2.MenuFragments.Units.model.UnitFinal.class);
            ...
            if (rowIndex != Table.NO_MATCH) {
                ...
                try {
                    objectContext.set(realm, table.getUncheckedRow(rowIndex), realm.getSchema().getColumnInfo(com.newlandapps.onroad.z_version2.MenuFragments.Units.model.UnitFinal.class), false, Collections.<String> emptyList());
                    obj = new io.realm.com_newlandapps_onroad_z_version2_MenuFragments_Units_model_UnitFinalRealmProxy();
                } finally {
                    objectContext.clear();
                }
            }
        ...
        if (obj == null) {
            if (json.has("id")) {
                if (json.isNull("id")) {
                    obj = (io.realm.com_newlandapps_onroad_z_version2_MenuFragments_Units_model_UnitFinalRealmProxy) realm.createObjectInternal(com.newlandapps.onroad.z_version2.MenuFragments.Units.model.UnitFinal.class, null, true, excludeFields);
                } else {
                    obj = (io.realm.com_newlandapps_onroad_z_version2_MenuFragments_Units_model_UnitFinalRealmProxy) realm.createObjectInternal(com.newlandapps.onroad.z_version2.MenuFragments.Units.model.UnitFinal.class, json.getInt("id"), true, excludeFields);
                }
            } else {
        ...
        final com_newlandapps_onroad_z_version2_MenuFragments_Units_model_UnitFinalRealmProxyInterface objProxy = (com_newlandapps_onroad_z_version2_MenuFragments_Units_model_UnitFinalRealmProxyInterface) obj;
    ...
    public static com.newlandapps.onroad.z_version2.MenuFragments.Units.model.UnitFinal createUsingJsonStream(Realm realm, JsonReader reader)
        throws IOException {
        boolean jsonHasPrimaryKey = false;
        final com.newlandapps.onroad.z_version2.MenuFragments.Units.model.UnitFinal obj = new com.newlandapps.onroad.z_version2.MenuFragments.Units.model.UnitFinal();
        final com_newlandapps_onroad_z_version2_MenuFragments_Units_model_UnitFinalRealmProxyInterface objProxy = (com_newlandapps_onroad_z_version2_MenuFragments_Units_model_UnitFinalRealmProxyInterface) obj;
        reader.beginObject();
    ...
    private static com_newlandapps_onroad_z_version2_MenuFragments_Units_model_UnitFinalRealmProxy newProxyInstance(BaseRealm realm, Row row) {
        // Ignore default values to avoid creating uexpected objects from RealmModel/RealmList fields
        final BaseRealm.RealmObjectContext objectContext = BaseRealm.objectContext.get();
        objectContext.set(realm, row, realm.getSchema().getColumnInfo(com.newlandapps.onroad.z_version2.MenuFragments.Units.model.UnitFinal.class), false, Collections.<String>emptyList());
        io.realm.com_newlandapps_onroad_z_version2_MenuFragments_Units_model_UnitFinalRealmProxy obj = new io.realm.com_newlandapps_onroad_z_version2_MenuFragments_Units_model_UnitFinalRealmProxy();
        objectContext.clear();
        return obj;
    }

    public static com.newlandapps.onroad.z_version2.MenuFragments.Units.model.UnitFinal copyOrUpdate(Realm realm, UnitFinalColumnInfo columnInfo, com.newlandapps.onroad.z_version2.MenuFragments.Units.model.UnitFinal object, boolean update, Map<RealmModel,RealmObjectProxy> cache, Set<ImportFlag> flags) {
        ...
        if (cachedRealmObject != null) {
            return (com.newlandapps.onroad.z_version2.MenuFragments.Units.model.UnitFinal) cachedRealmObject;
        }

        com.newlandapps.onroad.z_version2.MenuFragments.Units.model.UnitFinal realmObject = null;
        boolean canUpdate = update;
        if (canUpdate) {
            Table table = realm.getTable(com.newlandapps.onroad.z_version2.MenuFragments.Units.model.UnitFinal.class);
            long pkColumnIndex = columnInfo.idIndex;
            long rowIndex = table.findFirstLong(pkColumnIndex, ((com_newlandapps_onroad_z_version2_MenuFragments_Units_model_UnitFinalRealmProxyInterface) object).realmGet$id());
            if (rowIndex == Table.NO_MATCH) {
                canUpdate = false;
            } else {
                try {
                    objectContext.set(realm, table.getUncheckedRow(rowIndex), columnInfo, false, Collections.<String> emptyList());
                    realmObject = new io.realm.com_newlandapps_onroad_z_version2_MenuFragments_Units_model_UnitFinalRealmProxy();
    ...
    public static com.newlandapps.onroad.z_version2.MenuFragments.Units.model.UnitFinal copy(Realm realm, UnitFinalColumnInfo columnInfo, com.newlandapps.onroad.z_version2.MenuFragments.Units.model.UnitFinal newObject, boolean update, Map<RealmModel,RealmObjectProxy> cache, Set<ImportFlag> flags) {
        RealmObjectProxy cachedRealmObject = cache.get(newObject);
        if (cachedRealmObject != null) {
            return (com.newlandapps.onroad.z_version2.MenuFragments.Units.model.UnitFinal) cachedRealmObject;
        }

        com_newlandapps_onroad_z_version2_MenuFragments_Units_model_UnitFinalRealmProxyInterface realmObjectSource = (com_newlandapps_onroad_z_version2_MenuFragments_Units_model_UnitFinalRealmProxyInterface) newObject;
        ...
        io.realm.com_newlandapps_onroad_z_version2_MenuFragments_Units_model_UnitFinalRealmProxy realmObjectCopy = newProxyInstance(realm, row);
        cache.put(newObject, realmObjectCopy);

        return realmObjectCopy;
    }

    public static long insert(Realm realm, com.newlandapps.onroad.z_version2.MenuFragments.Units.model.UnitFinal object, Map<RealmModel,Long> cache) {
        ...
        long pkColumnIndex = columnInfo.idIndex;
        long rowIndex = Table.NO_MATCH;
        Object primaryKeyValue = ((com_newlandapps_onroad_z_version2_MenuFragments_Units_model_UnitFinalRealmProxyInterface) object).realmGet$id();
        if (primaryKeyValue != null) {
            rowIndex = Table.nativeFindFirstInt(tableNativePtr, pkColumnIndex, ((com_newlandapps_onroad_z_version2_MenuFragments_Units_model_UnitFinalRealmProxyInterface) object).realmGet$id());
        }
        if (rowIndex == Table.NO_MATCH) {
            rowIndex = OsObject.createRowWithPrimaryKey(table, pkColumnIndex, ((com_newlandapps_onroad_z_version2_MenuFragments_Units_model_UnitFinalRealmProxyInterface) object).realmGet$id());
        } else {
            Table.throwDuplicatePrimaryKeyException(primaryKeyValue);
        }
        cache.put(object, rowIndex);
        Table.nativeSetBoolean(tableNativePtr, columnInfo.vehicleStatusIndex, rowIndex, ((com_newlandapps_onroad_z_version2_MenuFragments_Units_model_UnitFinalRealmProxyInterface) object).realmGet$vehicleStatus(), false);
        Table.nativeSetLong(tableNativePtr, columnInfo.cveVehicleIndex, rowIndex, ((com_newlandapps_onroad_z_version2_MenuFragments_Units_model_UnitFinalRealmProxyInterface) object).realmGet$cveVehicle(), false);
        Table.nativeSetLong(tableNativePtr, columnInfo.vehicleSwitchIndex, rowIndex, ((com_newlandapps_onroad_z_version2_MenuFragments_Units_model_UnitFinalRealmProxyInterface) object).realmGet$vehicleSwitch(), false);
        String realmGet$vehicleName = ((com_newlandapps_onroad_z_version2_MenuFragments_Units_model_UnitFinalRealmProxyInterface) object).realmGet$vehicleName();
        ...
        String realmGet$vehicleImage = ((com_newlandapps_onroad_z_version2_MenuFragments_Units_model_UnitFinalRealmProxyInterface) object).realmGet$vehicleImage();
        ...
        String realmGet$sendTime = ((com_newlandapps_onroad_z_version2_MenuFragments_Units_model_UnitFinalRealmProxyInterface) object).realmGet$sendTime();
        if (realmGet$sendTime != null) {
            Table.nativeSetString(tableNativePtr, columnInfo.sendTimeIndex, rowIndex, realmGet$sendTime, false);
        }
        String realmGet$descBrand = ((com_newlandapps_onroad_z_version2_MenuFragments_Units_model_UnitFinalRealmProxyInterface) object).realmGet$descBrand();
        ...
        String realmGet$descModel = ((com_newlandapps_onroad_z_version2_MenuFragments_Units_model_UnitFinalRealmProxyInterface) object).realmGet$descModel();
        ...
        String realmGet$vehicleYear = ((com_newlandapps_onroad_z_version2_MenuFragments_Units_model_UnitFinalRealmProxyInterface) object).realmGet$vehicleYear();
        ...
        String realmGet$vehicleVin = ((com_newlandapps_onroad_z_version2_MenuFragments_Units_model_UnitFinalRealmProxyInterface) object).realmGet$vehicleVin();
        ...
        String realmGet$vehiclePlate = ((com_newlandapps_onroad_z_version2_MenuFragments_Units_model_UnitFinalRealmProxyInterface) object).realmGet$vehiclePlate();
        ...
        String realmGet$georeference = ((com_newlandapps_onroad_z_version2_MenuFragments_Units_model_UnitFinalRealmProxyInterface) object).realmGet$georeference();
        ...
        String realmGet$timeTravel = ((com_newlandapps_onroad_z_version2_MenuFragments_Units_model_UnitFinalRealmProxyInterface) object).realmGet$timeTravel();
        ...
        String realmGet$timeElapsed = ((com_newlandapps_onroad_z_version2_MenuFragments_Units_model_UnitFinalRealmProxyInterface) object).realmGet$timeElapsed();
        ...
        Table.nativeSetDouble(tableNativePtr, columnInfo.latitudeIndex, rowIndex, ((com_newlandapps_onroad_z_version2_MenuFragments_Units_model_UnitFinalRealmProxyInterface) object).realmGet$latitude(), false);
        Table.nativeSetDouble(tableNativePtr, columnInfo.longitudeIndex, rowIndex, ((com_newlandapps_onroad_z_version2_MenuFragments_Units_model_UnitFinalRealmProxyInterface) object).realmGet$longitude(), false);
        Table.nativeSetDouble(tableNativePtr, columnInfo.mileageIndex, rowIndex, ((com_newlandapps_onroad_z_version2_MenuFragments_Units_model_UnitFinalRealmProxyInterface) object).realmGet$mileage(), false);
        Table.nativeSetDouble(tableNativePtr, columnInfo.kmTravelIndex, rowIndex, ((com_newlandapps_onroad_z_version2_MenuFragments_Units_model_UnitFinalRealmProxyInterface) object).realmGet$kmTravel(), false);
        Table.nativeSetDouble(tableNativePtr, columnInfo.currentSpeedIndex, rowIndex, ((com_newlandapps_onroad_z_version2_MenuFragments_Units_model_UnitFinalRealmProxyInterface) object).realmGet$currentSpeed(), false);
        Table.nativeSetDouble(tableNativePtr, columnInfo.maxSpeedIndex, rowIndex, ((com_newlandapps_onroad_z_version2_MenuFragments_Units_model_UnitFinalRealmProxyInterface) object).realmGet$maxSpeed(), false);
        return rowIndex;
    }
    ...
    public static void insert(Realm realm, Iterator<? extends RealmModel> objects, Map<RealmModel,Long> cache) {
        ...
        UnitFinalColumnInfo columnInfo = (UnitFinalColumnInfo) realm.getSchema().getColumnInfo(com.newlandapps.onroad.z_version2.MenuFragments.Units.model.UnitFinal.class);
        long pkColumnIndex = columnInfo.idIndex;
        com.newlandapps.onroad.z_version2.MenuFragments.Units.model.UnitFinal object = null;
        while (objects.hasNext()) {
            object = (com.newlandapps.onroad.z_version2.MenuFragments.Units.model.UnitFinal) objects.next();
    ...
    public static long insertOrUpdate(Realm realm, com.newlandapps.onroad.z_version2.MenuFragments.Units.model.UnitFinal object, Map<RealmModel,Long> cache) {
        if (object instanceof RealmObjectProxy && ((RealmObjectProxy) object).realmGet$proxyState().getRealm$realm() != null && ((RealmObjectProxy) object).realmGet$proxyState().getRealm$realm().getPath().equals(realm.getPath())) {
            return ((RealmObjectProxy) object).realmGet$proxyState().getRow$realm().getIndex();
        }
        Table table = realm.getTable(com.newlandapps.onroad.z_version2.MenuFragments.Units.model.UnitFinal.class);
    ...
    public static com.newlandapps.onroad.z_version2.MenuFragments.Units.model.UnitFinal createDetachedCopy(com.newlandapps.onroad.z_version2.MenuFragments.Units.model.UnitFinal realmObject, int currentDepth, int maxDepth, Map<RealmModel, CacheData<RealmModel>> cache) {
        if (currentDepth > maxDepth || realmObject == null) {
            return null;
        }
        CacheData<RealmModel> cachedObject = cache.get(realmObject);
        com.newlandapps.onroad.z_version2.MenuFragments.Units.model.UnitFinal unmanagedObject;
        if (cachedObject == null) {
            unmanagedObject = new com.newlandapps.onroad.z_version2.MenuFragments.Units.model.UnitFinal();
            cache.put(realmObject, new RealmObjectProxy.CacheData<RealmModel>(currentDepth, unmanagedObject));
        } else {
            // Reuse cached object or recreate it because it was encountered at a lower depth.
            if (currentDepth >= cachedObject.minDepth) {
                return (com.newlandapps.onroad.z_version2.MenuFragments.Units.model.UnitFinal) cachedObject.object;
            }
            unmanagedObject = (com.newlandapps.onroad.z_version2.MenuFragments.Units.model.UnitFinal) cachedObject.object;
            cachedObject.minDepth = currentDepth;
        }
        com_newlandapps_onroad_z_version2_MenuFragments_Units_model_UnitFinalRealmProxyInterface unmanagedCopy = (com_newlandapps_onroad_z_version2_MenuFragments_Units_model_UnitFinalRealmProxyInterface) unmanagedObject;
        com_newlandapps_onroad_z_version2_MenuFragments_Units_model_UnitFinalRealmProxyInterface realmSource = (com_newlandapps_onroad_z_version2_MenuFragments_Units_model_UnitFinalRealmProxyInterface) realmObject;
    ...
    static com.newlandapps.onroad.z_version2.MenuFragments.Units.model.UnitFinal update(Realm realm, UnitFinalColumnInfo columnInfo, com.newlandapps.onroad.z_version2.MenuFragments.Units.model.UnitFinal realmObject, com.newlandapps.onroad.z_version2.MenuFragments.Units.model.UnitFinal newObject, Map<RealmModel, RealmObjectProxy> cache, Set<ImportFlag> flags) {
        com_newlandapps_onroad_z_version2_MenuFragments_Units_model_UnitFinalRealmProxyInterface realmObjectTarget = (com_newlandapps_onroad_z_version2_MenuFragments_Units_model_UnitFinalRealmProxyInterface) realmObject;
        com_newlandapps_onroad_z_version2_MenuFragments_Units_model_UnitFinalRealmProxyInterface realmObjectSource = (com_newlandapps_onroad_z_version2_MenuFragments_Units_model_UnitFinalRealmProxyInterface) newObject;
        Table table = realm.getTable(com.newlandapps.onroad.z_version2.MenuFragments.Units.model.UnitFinal.class);
        OsObjectBuilder builder = new OsObjectBuilder(table, columnInfo.maxColumnIndexValue, flags);
        builder.addInteger(columnInfo.idIndex, realmObjectSource.realmGet$id());
    ...
    public String toString() {
        ...
        StringBuilder stringBuilder = new StringBuilder("UnitFinal = proxy[");
    ...
    public boolean equals(Object o) {
        ...
        com_newlandapps_onroad_z_version2_MenuFragments_Units_model_UnitFinalRealmProxy aUnitFinal = (com_newlandapps_onroad_z_version2_MenuFragments_Units_model_UnitFinalRealmProxy)o;

        String path = proxyState.getRealm$realm().getPath();
        String otherPath = aUnitFinal.proxyState.getRealm$realm().getPath();
        if (path != null ? !path.equals(otherPath) : otherPath != null) return false;

        String tableName = proxyState.getRow$realm().getTable().getName();
        String otherTableName = aUnitFinal.proxyState.getRow$realm().getTable().getName();
        if (tableName != null ? !tableName.equals(otherTableName) : otherTableName != null) return false;

        if (proxyState.getRow$realm().getIndex() != aUnitFinal.proxyState.getRow$realm().getIndex()) return false;
