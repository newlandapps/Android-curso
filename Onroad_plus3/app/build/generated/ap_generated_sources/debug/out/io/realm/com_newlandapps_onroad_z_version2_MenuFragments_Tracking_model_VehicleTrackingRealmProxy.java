...
public class com_newlandapps_onroad_z_version2_MenuFragments_Tracking_model_VehicleTrackingRealmProxy extends com.newlandapps.onroad.z_version2.MenuFragments.Tracking.model.VehicleTracking
    implements RealmObjectProxy, com_newlandapps_onroad_z_version2_MenuFragments_Tracking_model_VehicleTrackingRealmProxyInterface {
    ...
    private ProxyState<com.newlandapps.onroad.z_version2.MenuFragments.Tracking.model.VehicleTracking> proxyState;
    ...
    public void realm$injectObjectContext() {
        ...
        this.proxyState = new ProxyState<com.newlandapps.onroad.z_version2.MenuFragments.Tracking.model.VehicleTracking>(this);
    ...
    @SuppressWarnings("cast")
    public static com.newlandapps.onroad.z_version2.MenuFragments.Tracking.model.VehicleTracking createOrUpdateUsingJsonObject(Realm realm, JSONObject json, boolean update)
        throws JSONException {
        final List<String> excludeFields = Collections.<String> emptyList();
        com.newlandapps.onroad.z_version2.MenuFragments.Tracking.model.VehicleTracking obj = null;
        if (update) {
            Table table = realm.getTable(com.newlandapps.onroad.z_version2.MenuFragments.Tracking.model.VehicleTracking.class);
            VehicleTrackingColumnInfo columnInfo = (VehicleTrackingColumnInfo) realm.getSchema().getColumnInfo(com.newlandapps.onroad.z_version2.MenuFragments.Tracking.model.VehicleTracking.class);
            ...
            if (rowIndex != Table.NO_MATCH) {
                ...
                try {
                    objectContext.set(realm, table.getUncheckedRow(rowIndex), realm.getSchema().getColumnInfo(com.newlandapps.onroad.z_version2.MenuFragments.Tracking.model.VehicleTracking.class), false, Collections.<String> emptyList());
                    obj = new io.realm.com_newlandapps_onroad_z_version2_MenuFragments_Tracking_model_VehicleTrackingRealmProxy();
                } finally {
                    objectContext.clear();
                }
            }
        ...
        if (obj == null) {
            if (json.has("id")) {
                if (json.isNull("id")) {
                    obj = (io.realm.com_newlandapps_onroad_z_version2_MenuFragments_Tracking_model_VehicleTrackingRealmProxy) realm.createObjectInternal(com.newlandapps.onroad.z_version2.MenuFragments.Tracking.model.VehicleTracking.class, null, true, excludeFields);
                } else {
                    obj = (io.realm.com_newlandapps_onroad_z_version2_MenuFragments_Tracking_model_VehicleTrackingRealmProxy) realm.createObjectInternal(com.newlandapps.onroad.z_version2.MenuFragments.Tracking.model.VehicleTracking.class, json.getInt("id"), true, excludeFields);
                }
            } else {
        ...
        final com_newlandapps_onroad_z_version2_MenuFragments_Tracking_model_VehicleTrackingRealmProxyInterface objProxy = (com_newlandapps_onroad_z_version2_MenuFragments_Tracking_model_VehicleTrackingRealmProxyInterface) obj;
    ...
    public static com.newlandapps.onroad.z_version2.MenuFragments.Tracking.model.VehicleTracking createUsingJsonStream(Realm realm, JsonReader reader)
        throws IOException {
        boolean jsonHasPrimaryKey = false;
        final com.newlandapps.onroad.z_version2.MenuFragments.Tracking.model.VehicleTracking obj = new com.newlandapps.onroad.z_version2.MenuFragments.Tracking.model.VehicleTracking();
        final com_newlandapps_onroad_z_version2_MenuFragments_Tracking_model_VehicleTrackingRealmProxyInterface objProxy = (com_newlandapps_onroad_z_version2_MenuFragments_Tracking_model_VehicleTrackingRealmProxyInterface) obj;
        reader.beginObject();
    ...
    private static com_newlandapps_onroad_z_version2_MenuFragments_Tracking_model_VehicleTrackingRealmProxy newProxyInstance(BaseRealm realm, Row row) {
        // Ignore default values to avoid creating uexpected objects from RealmModel/RealmList fields
        final BaseRealm.RealmObjectContext objectContext = BaseRealm.objectContext.get();
        objectContext.set(realm, row, realm.getSchema().getColumnInfo(com.newlandapps.onroad.z_version2.MenuFragments.Tracking.model.VehicleTracking.class), false, Collections.<String>emptyList());
        io.realm.com_newlandapps_onroad_z_version2_MenuFragments_Tracking_model_VehicleTrackingRealmProxy obj = new io.realm.com_newlandapps_onroad_z_version2_MenuFragments_Tracking_model_VehicleTrackingRealmProxy();
        objectContext.clear();
        return obj;
    }

    public static com.newlandapps.onroad.z_version2.MenuFragments.Tracking.model.VehicleTracking copyOrUpdate(Realm realm, VehicleTrackingColumnInfo columnInfo, com.newlandapps.onroad.z_version2.MenuFragments.Tracking.model.VehicleTracking object, boolean update, Map<RealmModel,RealmObjectProxy> cache, Set<ImportFlag> flags) {
        ...
        if (cachedRealmObject != null) {
            return (com.newlandapps.onroad.z_version2.MenuFragments.Tracking.model.VehicleTracking) cachedRealmObject;
        }

        com.newlandapps.onroad.z_version2.MenuFragments.Tracking.model.VehicleTracking realmObject = null;
        boolean canUpdate = update;
        if (canUpdate) {
            Table table = realm.getTable(com.newlandapps.onroad.z_version2.MenuFragments.Tracking.model.VehicleTracking.class);
            long pkColumnIndex = columnInfo.idIndex;
            long rowIndex = table.findFirstLong(pkColumnIndex, ((com_newlandapps_onroad_z_version2_MenuFragments_Tracking_model_VehicleTrackingRealmProxyInterface) object).realmGet$id());
            if (rowIndex == Table.NO_MATCH) {
                canUpdate = false;
            } else {
                try {
                    objectContext.set(realm, table.getUncheckedRow(rowIndex), columnInfo, false, Collections.<String> emptyList());
                    realmObject = new io.realm.com_newlandapps_onroad_z_version2_MenuFragments_Tracking_model_VehicleTrackingRealmProxy();
    ...
    public static com.newlandapps.onroad.z_version2.MenuFragments.Tracking.model.VehicleTracking copy(Realm realm, VehicleTrackingColumnInfo columnInfo, com.newlandapps.onroad.z_version2.MenuFragments.Tracking.model.VehicleTracking newObject, boolean update, Map<RealmModel,RealmObjectProxy> cache, Set<ImportFlag> flags) {
        RealmObjectProxy cachedRealmObject = cache.get(newObject);
        if (cachedRealmObject != null) {
            return (com.newlandapps.onroad.z_version2.MenuFragments.Tracking.model.VehicleTracking) cachedRealmObject;
        }

        com_newlandapps_onroad_z_version2_MenuFragments_Tracking_model_VehicleTrackingRealmProxyInterface realmObjectSource = (com_newlandapps_onroad_z_version2_MenuFragments_Tracking_model_VehicleTrackingRealmProxyInterface) newObject;
        ...
        io.realm.com_newlandapps_onroad_z_version2_MenuFragments_Tracking_model_VehicleTrackingRealmProxy realmObjectCopy = newProxyInstance(realm, row);
        cache.put(newObject, realmObjectCopy);

        return realmObjectCopy;
    }

    public static long insert(Realm realm, com.newlandapps.onroad.z_version2.MenuFragments.Tracking.model.VehicleTracking object, Map<RealmModel,Long> cache) {
        ...
        long pkColumnIndex = columnInfo.idIndex;
        long rowIndex = Table.NO_MATCH;
        Object primaryKeyValue = ((com_newlandapps_onroad_z_version2_MenuFragments_Tracking_model_VehicleTrackingRealmProxyInterface) object).realmGet$id();
        if (primaryKeyValue != null) {
            rowIndex = Table.nativeFindFirstInt(tableNativePtr, pkColumnIndex, ((com_newlandapps_onroad_z_version2_MenuFragments_Tracking_model_VehicleTrackingRealmProxyInterface) object).realmGet$id());
        }
        if (rowIndex == Table.NO_MATCH) {
            rowIndex = OsObject.createRowWithPrimaryKey(table, pkColumnIndex, ((com_newlandapps_onroad_z_version2_MenuFragments_Tracking_model_VehicleTrackingRealmProxyInterface) object).realmGet$id());
        } else {
            Table.throwDuplicatePrimaryKeyException(primaryKeyValue);
        }
        cache.put(object, rowIndex);
        Table.nativeSetLong(tableNativePtr, columnInfo.cve_vehicleIndex, rowIndex, ((com_newlandapps_onroad_z_version2_MenuFragments_Tracking_model_VehicleTrackingRealmProxyInterface) object).realmGet$cve_vehicle(), false);
        String realmGet$userVehicle = ((com_newlandapps_onroad_z_version2_MenuFragments_Tracking_model_VehicleTrackingRealmProxyInterface) object).realmGet$userVehicle();
        ...
        String realmGet$vehicle_name = ((com_newlandapps_onroad_z_version2_MenuFragments_Tracking_model_VehicleTrackingRealmProxyInterface) object).realmGet$vehicle_name();
        ...
        String realmGet$vehicle_image = ((com_newlandapps_onroad_z_version2_MenuFragments_Tracking_model_VehicleTrackingRealmProxyInterface) object).realmGet$vehicle_image();
        ...
        Table.nativeSetDouble(tableNativePtr, columnInfo.latitudeIndex, rowIndex, ((com_newlandapps_onroad_z_version2_MenuFragments_Tracking_model_VehicleTrackingRealmProxyInterface) object).realmGet$latitude(), false);
        Table.nativeSetDouble(tableNativePtr, columnInfo.longitudeIndex, rowIndex, ((com_newlandapps_onroad_z_version2_MenuFragments_Tracking_model_VehicleTrackingRealmProxyInterface) object).realmGet$longitude(), false);
        Table.nativeSetBoolean(tableNativePtr, columnInfo.selectedIndex, rowIndex, ((com_newlandapps_onroad_z_version2_MenuFragments_Tracking_model_VehicleTrackingRealmProxyInterface) object).realmGet$selected(), false);
        Table.nativeSetLong(tableNativePtr, columnInfo.positionItemIndex, rowIndex, ((com_newlandapps_onroad_z_version2_MenuFragments_Tracking_model_VehicleTrackingRealmProxyInterface) object).realmGet$positionItem(), false);
        Table.nativeSetLong(tableNativePtr, columnInfo.vehicle_switchIndex, rowIndex, ((com_newlandapps_onroad_z_version2_MenuFragments_Tracking_model_VehicleTrackingRealmProxyInterface) object).realmGet$vehicle_switch(), false);
        return rowIndex;
    }
    ...
    public static void insert(Realm realm, Iterator<? extends RealmModel> objects, Map<RealmModel,Long> cache) {
        ...
        VehicleTrackingColumnInfo columnInfo = (VehicleTrackingColumnInfo) realm.getSchema().getColumnInfo(com.newlandapps.onroad.z_version2.MenuFragments.Tracking.model.VehicleTracking.class);
        long pkColumnIndex = columnInfo.idIndex;
        com.newlandapps.onroad.z_version2.MenuFragments.Tracking.model.VehicleTracking object = null;
        while (objects.hasNext()) {
            object = (com.newlandapps.onroad.z_version2.MenuFragments.Tracking.model.VehicleTracking) objects.next();
    ...
    public static long insertOrUpdate(Realm realm, com.newlandapps.onroad.z_version2.MenuFragments.Tracking.model.VehicleTracking object, Map<RealmModel,Long> cache) {
        if (object instanceof RealmObjectProxy && ((RealmObjectProxy) object).realmGet$proxyState().getRealm$realm() != null && ((RealmObjectProxy) object).realmGet$proxyState().getRealm$realm().getPath().equals(realm.getPath())) {
            return ((RealmObjectProxy) object).realmGet$proxyState().getRow$realm().getIndex();
        }
        Table table = realm.getTable(com.newlandapps.onroad.z_version2.MenuFragments.Tracking.model.VehicleTracking.class);
    ...
    public static com.newlandapps.onroad.z_version2.MenuFragments.Tracking.model.VehicleTracking createDetachedCopy(com.newlandapps.onroad.z_version2.MenuFragments.Tracking.model.VehicleTracking realmObject, int currentDepth, int maxDepth, Map<RealmModel, CacheData<RealmModel>> cache) {
        if (currentDepth > maxDepth || realmObject == null) {
            return null;
        }
        CacheData<RealmModel> cachedObject = cache.get(realmObject);
        com.newlandapps.onroad.z_version2.MenuFragments.Tracking.model.VehicleTracking unmanagedObject;
        if (cachedObject == null) {
            unmanagedObject = new com.newlandapps.onroad.z_version2.MenuFragments.Tracking.model.VehicleTracking();
            cache.put(realmObject, new RealmObjectProxy.CacheData<RealmModel>(currentDepth, unmanagedObject));
        } else {
            // Reuse cached object or recreate it because it was encountered at a lower depth.
            if (currentDepth >= cachedObject.minDepth) {
                return (com.newlandapps.onroad.z_version2.MenuFragments.Tracking.model.VehicleTracking) cachedObject.object;
            }
            unmanagedObject = (com.newlandapps.onroad.z_version2.MenuFragments.Tracking.model.VehicleTracking) cachedObject.object;
            cachedObject.minDepth = currentDepth;
        }
        com_newlandapps_onroad_z_version2_MenuFragments_Tracking_model_VehicleTrackingRealmProxyInterface unmanagedCopy = (com_newlandapps_onroad_z_version2_MenuFragments_Tracking_model_VehicleTrackingRealmProxyInterface) unmanagedObject;
        com_newlandapps_onroad_z_version2_MenuFragments_Tracking_model_VehicleTrackingRealmProxyInterface realmSource = (com_newlandapps_onroad_z_version2_MenuFragments_Tracking_model_VehicleTrackingRealmProxyInterface) realmObject;
    ...
    static com.newlandapps.onroad.z_version2.MenuFragments.Tracking.model.VehicleTracking update(Realm realm, VehicleTrackingColumnInfo columnInfo, com.newlandapps.onroad.z_version2.MenuFragments.Tracking.model.VehicleTracking realmObject, com.newlandapps.onroad.z_version2.MenuFragments.Tracking.model.VehicleTracking newObject, Map<RealmModel, RealmObjectProxy> cache, Set<ImportFlag> flags) {
        com_newlandapps_onroad_z_version2_MenuFragments_Tracking_model_VehicleTrackingRealmProxyInterface realmObjectTarget = (com_newlandapps_onroad_z_version2_MenuFragments_Tracking_model_VehicleTrackingRealmProxyInterface) realmObject;
        com_newlandapps_onroad_z_version2_MenuFragments_Tracking_model_VehicleTrackingRealmProxyInterface realmObjectSource = (com_newlandapps_onroad_z_version2_MenuFragments_Tracking_model_VehicleTrackingRealmProxyInterface) newObject;
        Table table = realm.getTable(com.newlandapps.onroad.z_version2.MenuFragments.Tracking.model.VehicleTracking.class);
        OsObjectBuilder builder = new OsObjectBuilder(table, columnInfo.maxColumnIndexValue, flags);
        builder.addInteger(columnInfo.idIndex, realmObjectSource.realmGet$id());
    ...
    public boolean equals(Object o) {
        ...
        com_newlandapps_onroad_z_version2_MenuFragments_Tracking_model_VehicleTrackingRealmProxy aVehicleTracking = (com_newlandapps_onroad_z_version2_MenuFragments_Tracking_model_VehicleTrackingRealmProxy)o;
