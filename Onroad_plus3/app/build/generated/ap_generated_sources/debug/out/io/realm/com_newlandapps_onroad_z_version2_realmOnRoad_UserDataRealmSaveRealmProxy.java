...
public class com_newlandapps_onroad_z_version2_realmOnRoad_UserDataRealmSaveRealmProxy extends com.newlandapps.onroad.z_version2.realmOnRoad.UserDataRealmSave
    implements RealmObjectProxy, com_newlandapps_onroad_z_version2_realmOnRoad_UserDataRealmSaveRealmProxyInterface {
    ...
    private ProxyState<com.newlandapps.onroad.z_version2.realmOnRoad.UserDataRealmSave> proxyState;
    ...
    public void realm$injectObjectContext() {
        ...
        this.proxyState = new ProxyState<com.newlandapps.onroad.z_version2.realmOnRoad.UserDataRealmSave>(this);
    ...
    @SuppressWarnings("cast")
    public static com.newlandapps.onroad.z_version2.realmOnRoad.UserDataRealmSave createOrUpdateUsingJsonObject(Realm realm, JSONObject json, boolean update)
        throws JSONException {
        final List<String> excludeFields = Collections.<String> emptyList();
        com.newlandapps.onroad.z_version2.realmOnRoad.UserDataRealmSave obj = realm.createObjectInternal(com.newlandapps.onroad.z_version2.realmOnRoad.UserDataRealmSave.class, true, excludeFields);

        final com_newlandapps_onroad_z_version2_realmOnRoad_UserDataRealmSaveRealmProxyInterface objProxy = (com_newlandapps_onroad_z_version2_realmOnRoad_UserDataRealmSaveRealmProxyInterface) obj;
    ...
    public static com.newlandapps.onroad.z_version2.realmOnRoad.UserDataRealmSave createUsingJsonStream(Realm realm, JsonReader reader)
        throws IOException {
        final com.newlandapps.onroad.z_version2.realmOnRoad.UserDataRealmSave obj = new com.newlandapps.onroad.z_version2.realmOnRoad.UserDataRealmSave();
        final com_newlandapps_onroad_z_version2_realmOnRoad_UserDataRealmSaveRealmProxyInterface objProxy = (com_newlandapps_onroad_z_version2_realmOnRoad_UserDataRealmSaveRealmProxyInterface) obj;
        reader.beginObject();
    ...
    private static com_newlandapps_onroad_z_version2_realmOnRoad_UserDataRealmSaveRealmProxy newProxyInstance(BaseRealm realm, Row row) {
        // Ignore default values to avoid creating uexpected objects from RealmModel/RealmList fields
        final BaseRealm.RealmObjectContext objectContext = BaseRealm.objectContext.get();
        objectContext.set(realm, row, realm.getSchema().getColumnInfo(com.newlandapps.onroad.z_version2.realmOnRoad.UserDataRealmSave.class), false, Collections.<String>emptyList());
        io.realm.com_newlandapps_onroad_z_version2_realmOnRoad_UserDataRealmSaveRealmProxy obj = new io.realm.com_newlandapps_onroad_z_version2_realmOnRoad_UserDataRealmSaveRealmProxy();
        objectContext.clear();
        return obj;
    }

    public static com.newlandapps.onroad.z_version2.realmOnRoad.UserDataRealmSave copyOrUpdate(Realm realm, UserDataRealmSaveColumnInfo columnInfo, com.newlandapps.onroad.z_version2.realmOnRoad.UserDataRealmSave object, boolean update, Map<RealmModel,RealmObjectProxy> cache, Set<ImportFlag> flags) {
        ...
        if (cachedRealmObject != null) {
            return (com.newlandapps.onroad.z_version2.realmOnRoad.UserDataRealmSave) cachedRealmObject;
        }

        return copy(realm, columnInfo, object, update, cache, flags);
    }

    public static com.newlandapps.onroad.z_version2.realmOnRoad.UserDataRealmSave copy(Realm realm, UserDataRealmSaveColumnInfo columnInfo, com.newlandapps.onroad.z_version2.realmOnRoad.UserDataRealmSave newObject, boolean update, Map<RealmModel,RealmObjectProxy> cache, Set<ImportFlag> flags) {
        RealmObjectProxy cachedRealmObject = cache.get(newObject);
        if (cachedRealmObject != null) {
            return (com.newlandapps.onroad.z_version2.realmOnRoad.UserDataRealmSave) cachedRealmObject;
        }

        com_newlandapps_onroad_z_version2_realmOnRoad_UserDataRealmSaveRealmProxyInterface realmObjectSource = (com_newlandapps_onroad_z_version2_realmOnRoad_UserDataRealmSaveRealmProxyInterface) newObject;

        Table table = realm.getTable(com.newlandapps.onroad.z_version2.realmOnRoad.UserDataRealmSave.class);
        ...
        io.realm.com_newlandapps_onroad_z_version2_realmOnRoad_UserDataRealmSaveRealmProxy realmObjectCopy = newProxyInstance(realm, row);
        cache.put(newObject, realmObjectCopy);

        return realmObjectCopy;
    }

    public static long insert(Realm realm, com.newlandapps.onroad.z_version2.realmOnRoad.UserDataRealmSave object, Map<RealmModel,Long> cache) {
        if (object instanceof RealmObjectProxy && ((RealmObjectProxy) object).realmGet$proxyState().getRealm$realm() != null && ((RealmObjectProxy) object).realmGet$proxyState().getRealm$realm().getPath().equals(realm.getPath())) {
            return ((RealmObjectProxy) object).realmGet$proxyState().getRow$realm().getIndex();
        }
        Table table = realm.getTable(com.newlandapps.onroad.z_version2.realmOnRoad.UserDataRealmSave.class);
        long tableNativePtr = table.getNativePtr();
        UserDataRealmSaveColumnInfo columnInfo = (UserDataRealmSaveColumnInfo) realm.getSchema().getColumnInfo(com.newlandapps.onroad.z_version2.realmOnRoad.UserDataRealmSave.class);
        long rowIndex = OsObject.createRow(table);
        cache.put(object, rowIndex);
        String realmGet$userName = ((com_newlandapps_onroad_z_version2_realmOnRoad_UserDataRealmSaveRealmProxyInterface) object).realmGet$userName();
        if (realmGet$userName != null) {
            Table.nativeSetString(tableNativePtr, columnInfo.userNameIndex, rowIndex, realmGet$userName, false);
        }
        String realmGet$email = ((com_newlandapps_onroad_z_version2_realmOnRoad_UserDataRealmSaveRealmProxyInterface) object).realmGet$email();
        if (realmGet$email != null) {
            Table.nativeSetString(tableNativePtr, columnInfo.emailIndex, rowIndex, realmGet$email, false);
        }
        String realmGet$password = ((com_newlandapps_onroad_z_version2_realmOnRoad_UserDataRealmSaveRealmProxyInterface) object).realmGet$password();
        if (realmGet$password != null) {
            Table.nativeSetString(tableNativePtr, columnInfo.passwordIndex, rowIndex, realmGet$password, false);
        }
        Table.nativeSetBoolean(tableNativePtr, columnInfo.isFirstTimeIndex, rowIndex, ((com_newlandapps_onroad_z_version2_realmOnRoad_UserDataRealmSaveRealmProxyInterface) object).realmGet$isFirstTime(), false);
        return rowIndex;
    }
    ...
    public static void insert(Realm realm, Iterator<? extends RealmModel> objects, Map<RealmModel,Long> cache) {
        ...
        long tableNativePtr = table.getNativePtr();
        UserDataRealmSaveColumnInfo columnInfo = (UserDataRealmSaveColumnInfo) realm.getSchema().getColumnInfo(com.newlandapps.onroad.z_version2.realmOnRoad.UserDataRealmSave.class);
        com.newlandapps.onroad.z_version2.realmOnRoad.UserDataRealmSave object = null;
        while (objects.hasNext()) {
            object = (com.newlandapps.onroad.z_version2.realmOnRoad.UserDataRealmSave) objects.next();
    ...
    public static long insertOrUpdate(Realm realm, com.newlandapps.onroad.z_version2.realmOnRoad.UserDataRealmSave object, Map<RealmModel,Long> cache) {
        if (object instanceof RealmObjectProxy && ((RealmObjectProxy) object).realmGet$proxyState().getRealm$realm() != null && ((RealmObjectProxy) object).realmGet$proxyState().getRealm$realm().getPath().equals(realm.getPath())) {
            return ((RealmObjectProxy) object).realmGet$proxyState().getRow$realm().getIndex();
        }
        Table table = realm.getTable(com.newlandapps.onroad.z_version2.realmOnRoad.UserDataRealmSave.class);
    ...
    public static com.newlandapps.onroad.z_version2.realmOnRoad.UserDataRealmSave createDetachedCopy(com.newlandapps.onroad.z_version2.realmOnRoad.UserDataRealmSave realmObject, int currentDepth, int maxDepth, Map<RealmModel, CacheData<RealmModel>> cache) {
        if (currentDepth > maxDepth || realmObject == null) {
            return null;
        }
        CacheData<RealmModel> cachedObject = cache.get(realmObject);
        com.newlandapps.onroad.z_version2.realmOnRoad.UserDataRealmSave unmanagedObject;
        if (cachedObject == null) {
            unmanagedObject = new com.newlandapps.onroad.z_version2.realmOnRoad.UserDataRealmSave();
            cache.put(realmObject, new RealmObjectProxy.CacheData<RealmModel>(currentDepth, unmanagedObject));
        } else {
            // Reuse cached object or recreate it because it was encountered at a lower depth.
            if (currentDepth >= cachedObject.minDepth) {
                return (com.newlandapps.onroad.z_version2.realmOnRoad.UserDataRealmSave) cachedObject.object;
            }
            unmanagedObject = (com.newlandapps.onroad.z_version2.realmOnRoad.UserDataRealmSave) cachedObject.object;
            cachedObject.minDepth = currentDepth;
        }
        com_newlandapps_onroad_z_version2_realmOnRoad_UserDataRealmSaveRealmProxyInterface unmanagedCopy = (com_newlandapps_onroad_z_version2_realmOnRoad_UserDataRealmSaveRealmProxyInterface) unmanagedObject;
        com_newlandapps_onroad_z_version2_realmOnRoad_UserDataRealmSaveRealmProxyInterface realmSource = (com_newlandapps_onroad_z_version2_realmOnRoad_UserDataRealmSaveRealmProxyInterface) realmObject;
    ...
    public boolean equals(Object o) {
        ...
        com_newlandapps_onroad_z_version2_realmOnRoad_UserDataRealmSaveRealmProxy aUserDataRealmSave = (com_newlandapps_onroad_z_version2_realmOnRoad_UserDataRealmSaveRealmProxy)o;
