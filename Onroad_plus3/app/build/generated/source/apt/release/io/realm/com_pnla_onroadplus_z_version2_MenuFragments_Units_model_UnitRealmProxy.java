...
public class com_pnla_onroadplus_z_version2_MenuFragments_Units_model_UnitRealmProxy extends com.pnla.onroadplus.z_version2.MenuFragments.Units.model.Unit
    implements RealmObjectProxy, com_pnla_onroadplus_z_version2_MenuFragments_Units_model_UnitRealmProxyInterface {
    ...
    private ProxyState<com.pnla.onroadplus.z_version2.MenuFragments.Units.model.Unit> proxyState;

    com_pnla_onroadplus_z_version2_MenuFragments_Units_model_UnitRealmProxy() {
    ...
    public void realm$injectObjectContext() {
        ...
        this.proxyState = new ProxyState<com.pnla.onroadplus.z_version2.MenuFragments.Units.model.Unit>(this);
    ...
    @SuppressWarnings("cast")
    public static com.pnla.onroadplus.z_version2.MenuFragments.Units.model.Unit createOrUpdateUsingJsonObject(Realm realm, JSONObject json, boolean update)
        throws JSONException {
        final List<String> excludeFields = Collections.<String> emptyList();
        com.pnla.onroadplus.z_version2.MenuFragments.Units.model.Unit obj = null;
        if (update) {
            Table table = realm.getTable(com.pnla.onroadplus.z_version2.MenuFragments.Units.model.Unit.class);
            UnitColumnInfo columnInfo = (UnitColumnInfo) realm.getSchema().getColumnInfo(com.pnla.onroadplus.z_version2.MenuFragments.Units.model.Unit.class);
            ...
            if (rowIndex != Table.NO_MATCH) {
                ...
                try {
                    objectContext.set(realm, table.getUncheckedRow(rowIndex), realm.getSchema().getColumnInfo(com.pnla.onroadplus.z_version2.MenuFragments.Units.model.Unit.class), false, Collections.<String> emptyList());
                    obj = new io.realm.com_pnla_onroadplus_z_version2_MenuFragments_Units_model_UnitRealmProxy();
                } finally {
                    objectContext.clear();
                }
            }
        ...
        if (obj == null) {
            if (json.has("id")) {
                if (json.isNull("id")) {
                    obj = (io.realm.com_pnla_onroadplus_z_version2_MenuFragments_Units_model_UnitRealmProxy) realm.createObjectInternal(com.pnla.onroadplus.z_version2.MenuFragments.Units.model.Unit.class, null, true, excludeFields);
                } else {
                    obj = (io.realm.com_pnla_onroadplus_z_version2_MenuFragments_Units_model_UnitRealmProxy) realm.createObjectInternal(com.pnla.onroadplus.z_version2.MenuFragments.Units.model.Unit.class, json.getInt("id"), true, excludeFields);
                }
            } else {
        ...
        final com_pnla_onroadplus_z_version2_MenuFragments_Units_model_UnitRealmProxyInterface objProxy = (com_pnla_onroadplus_z_version2_MenuFragments_Units_model_UnitRealmProxyInterface) obj;
    ...
    public static com.pnla.onroadplus.z_version2.MenuFragments.Units.model.Unit createUsingJsonStream(Realm realm, JsonReader reader)
        throws IOException {
        boolean jsonHasPrimaryKey = false;
        final com.pnla.onroadplus.z_version2.MenuFragments.Units.model.Unit obj = new com.pnla.onroadplus.z_version2.MenuFragments.Units.model.Unit();
        final com_pnla_onroadplus_z_version2_MenuFragments_Units_model_UnitRealmProxyInterface objProxy = (com_pnla_onroadplus_z_version2_MenuFragments_Units_model_UnitRealmProxyInterface) obj;
        reader.beginObject();
    ...
    private static com_pnla_onroadplus_z_version2_MenuFragments_Units_model_UnitRealmProxy newProxyInstance(BaseRealm realm, Row row) {
        // Ignore default values to avoid creating uexpected objects from RealmModel/RealmList fields
        final BaseRealm.RealmObjectContext objectContext = BaseRealm.objectContext.get();
        objectContext.set(realm, row, realm.getSchema().getColumnInfo(com.pnla.onroadplus.z_version2.MenuFragments.Units.model.Unit.class), false, Collections.<String>emptyList());
        io.realm.com_pnla_onroadplus_z_version2_MenuFragments_Units_model_UnitRealmProxy obj = new io.realm.com_pnla_onroadplus_z_version2_MenuFragments_Units_model_UnitRealmProxy();
        objectContext.clear();
        return obj;
    }

    public static com.pnla.onroadplus.z_version2.MenuFragments.Units.model.Unit copyOrUpdate(Realm realm, UnitColumnInfo columnInfo, com.pnla.onroadplus.z_version2.MenuFragments.Units.model.Unit object, boolean update, Map<RealmModel,RealmObjectProxy> cache, Set<ImportFlag> flags) {
        ...
        if (cachedRealmObject != null) {
            return (com.pnla.onroadplus.z_version2.MenuFragments.Units.model.Unit) cachedRealmObject;
        }

        com.pnla.onroadplus.z_version2.MenuFragments.Units.model.Unit realmObject = null;
        boolean canUpdate = update;
        if (canUpdate) {
            Table table = realm.getTable(com.pnla.onroadplus.z_version2.MenuFragments.Units.model.Unit.class);
            long pkColumnIndex = columnInfo.idIndex;
            long rowIndex = table.findFirstLong(pkColumnIndex, ((com_pnla_onroadplus_z_version2_MenuFragments_Units_model_UnitRealmProxyInterface) object).realmGet$id());
            if (rowIndex == Table.NO_MATCH) {
                canUpdate = false;
            } else {
                try {
                    objectContext.set(realm, table.getUncheckedRow(rowIndex), columnInfo, false, Collections.<String> emptyList());
                    realmObject = new io.realm.com_pnla_onroadplus_z_version2_MenuFragments_Units_model_UnitRealmProxy();
    ...
    public static com.pnla.onroadplus.z_version2.MenuFragments.Units.model.Unit copy(Realm realm, UnitColumnInfo columnInfo, com.pnla.onroadplus.z_version2.MenuFragments.Units.model.Unit newObject, boolean update, Map<RealmModel,RealmObjectProxy> cache, Set<ImportFlag> flags) {
        RealmObjectProxy cachedRealmObject = cache.get(newObject);
        if (cachedRealmObject != null) {
            return (com.pnla.onroadplus.z_version2.MenuFragments.Units.model.Unit) cachedRealmObject;
        }

        com_pnla_onroadplus_z_version2_MenuFragments_Units_model_UnitRealmProxyInterface realmObjectSource = (com_pnla_onroadplus_z_version2_MenuFragments_Units_model_UnitRealmProxyInterface) newObject;
        ...
        io.realm.com_pnla_onroadplus_z_version2_MenuFragments_Units_model_UnitRealmProxy realmObjectCopy = newProxyInstance(realm, row);
        cache.put(newObject, realmObjectCopy);

        return realmObjectCopy;
    }

    public static long insert(Realm realm, com.pnla.onroadplus.z_version2.MenuFragments.Units.model.Unit object, Map<RealmModel,Long> cache) {
        ...
        long pkColumnIndex = columnInfo.idIndex;
        long rowIndex = Table.NO_MATCH;
        Object primaryKeyValue = ((com_pnla_onroadplus_z_version2_MenuFragments_Units_model_UnitRealmProxyInterface) object).realmGet$id();
        if (primaryKeyValue != null) {
            rowIndex = Table.nativeFindFirstInt(tableNativePtr, pkColumnIndex, ((com_pnla_onroadplus_z_version2_MenuFragments_Units_model_UnitRealmProxyInterface) object).realmGet$id());
        }
        if (rowIndex == Table.NO_MATCH) {
            rowIndex = OsObject.createRowWithPrimaryKey(table, pkColumnIndex, ((com_pnla_onroadplus_z_version2_MenuFragments_Units_model_UnitRealmProxyInterface) object).realmGet$id());
        } else {
            Table.throwDuplicatePrimaryKeyException(primaryKeyValue);
        }
        cache.put(object, rowIndex);
        Table.nativeSetBoolean(tableNativePtr, columnInfo.vehicleStatusIndex, rowIndex, ((com_pnla_onroadplus_z_version2_MenuFragments_Units_model_UnitRealmProxyInterface) object).realmGet$vehicleStatus(), false);
        Table.nativeSetLong(tableNativePtr, columnInfo.cveVehicleIndex, rowIndex, ((com_pnla_onroadplus_z_version2_MenuFragments_Units_model_UnitRealmProxyInterface) object).realmGet$cveVehicle(), false);
        Table.nativeSetLong(tableNativePtr, columnInfo.vehicleSwitchIndex, rowIndex, ((com_pnla_onroadplus_z_version2_MenuFragments_Units_model_UnitRealmProxyInterface) object).realmGet$vehicleSwitch(), false);
        String realmGet$vehicleName = ((com_pnla_onroadplus_z_version2_MenuFragments_Units_model_UnitRealmProxyInterface) object).realmGet$vehicleName();
        ...
        String realmGet$vehicleImage = ((com_pnla_onroadplus_z_version2_MenuFragments_Units_model_UnitRealmProxyInterface) object).realmGet$vehicleImage();
        ...
        String realmGet$sendTime = ((com_pnla_onroadplus_z_version2_MenuFragments_Units_model_UnitRealmProxyInterface) object).realmGet$sendTime();
        if (realmGet$sendTime != null) {
            Table.nativeSetString(tableNativePtr, columnInfo.sendTimeIndex, rowIndex, realmGet$sendTime, false);
        }
        String realmGet$descBrand = ((com_pnla_onroadplus_z_version2_MenuFragments_Units_model_UnitRealmProxyInterface) object).realmGet$descBrand();
        ...
        String realmGet$descModel = ((com_pnla_onroadplus_z_version2_MenuFragments_Units_model_UnitRealmProxyInterface) object).realmGet$descModel();
        ...
        String realmGet$vehicleYear = ((com_pnla_onroadplus_z_version2_MenuFragments_Units_model_UnitRealmProxyInterface) object).realmGet$vehicleYear();
        ...
        String realmGet$vehicleVin = ((com_pnla_onroadplus_z_version2_MenuFragments_Units_model_UnitRealmProxyInterface) object).realmGet$vehicleVin();
        ...
        String realmGet$vehiclePlate = ((com_pnla_onroadplus_z_version2_MenuFragments_Units_model_UnitRealmProxyInterface) object).realmGet$vehiclePlate();
        ...
        String realmGet$georeference = ((com_pnla_onroadplus_z_version2_MenuFragments_Units_model_UnitRealmProxyInterface) object).realmGet$georeference();
        ...
        String realmGet$timeTravel = ((com_pnla_onroadplus_z_version2_MenuFragments_Units_model_UnitRealmProxyInterface) object).realmGet$timeTravel();
        ...
        String realmGet$timeElapsed = ((com_pnla_onroadplus_z_version2_MenuFragments_Units_model_UnitRealmProxyInterface) object).realmGet$timeElapsed();
        ...
        Table.nativeSetDouble(tableNativePtr, columnInfo.latitudeIndex, rowIndex, ((com_pnla_onroadplus_z_version2_MenuFragments_Units_model_UnitRealmProxyInterface) object).realmGet$latitude(), false);
        Table.nativeSetDouble(tableNativePtr, columnInfo.longitudeIndex, rowIndex, ((com_pnla_onroadplus_z_version2_MenuFragments_Units_model_UnitRealmProxyInterface) object).realmGet$longitude(), false);
        Table.nativeSetDouble(tableNativePtr, columnInfo.mileageIndex, rowIndex, ((com_pnla_onroadplus_z_version2_MenuFragments_Units_model_UnitRealmProxyInterface) object).realmGet$mileage(), false);
        Table.nativeSetDouble(tableNativePtr, columnInfo.kmTravelIndex, rowIndex, ((com_pnla_onroadplus_z_version2_MenuFragments_Units_model_UnitRealmProxyInterface) object).realmGet$kmTravel(), false);
        Table.nativeSetDouble(tableNativePtr, columnInfo.currentSpeedIndex, rowIndex, ((com_pnla_onroadplus_z_version2_MenuFragments_Units_model_UnitRealmProxyInterface) object).realmGet$currentSpeed(), false);
        Table.nativeSetDouble(tableNativePtr, columnInfo.maxSpeedIndex, rowIndex, ((com_pnla_onroadplus_z_version2_MenuFragments_Units_model_UnitRealmProxyInterface) object).realmGet$maxSpeed(), false);
        return rowIndex;
    }
    ...
    public static void insert(Realm realm, Iterator<? extends RealmModel> objects, Map<RealmModel,Long> cache) {
        ...
        UnitColumnInfo columnInfo = (UnitColumnInfo) realm.getSchema().getColumnInfo(com.pnla.onroadplus.z_version2.MenuFragments.Units.model.Unit.class);
        long pkColumnIndex = columnInfo.idIndex;
        com.pnla.onroadplus.z_version2.MenuFragments.Units.model.Unit object = null;
        while (objects.hasNext()) {
            object = (com.pnla.onroadplus.z_version2.MenuFragments.Units.model.Unit) objects.next();
    ...
    public static long insertOrUpdate(Realm realm, com.pnla.onroadplus.z_version2.MenuFragments.Units.model.Unit object, Map<RealmModel,Long> cache) {
        if (object instanceof RealmObjectProxy && ((RealmObjectProxy) object).realmGet$proxyState().getRealm$realm() != null && ((RealmObjectProxy) object).realmGet$proxyState().getRealm$realm().getPath().equals(realm.getPath())) {
            return ((RealmObjectProxy) object).realmGet$proxyState().getRow$realm().getIndex();
        }
        Table table = realm.getTable(com.pnla.onroadplus.z_version2.MenuFragments.Units.model.Unit.class);
    ...
    public static com.pnla.onroadplus.z_version2.MenuFragments.Units.model.Unit createDetachedCopy(com.pnla.onroadplus.z_version2.MenuFragments.Units.model.Unit realmObject, int currentDepth, int maxDepth, Map<RealmModel, CacheData<RealmModel>> cache) {
        if (currentDepth > maxDepth || realmObject == null) {
            return null;
        }
        CacheData<RealmModel> cachedObject = cache.get(realmObject);
        com.pnla.onroadplus.z_version2.MenuFragments.Units.model.Unit unmanagedObject;
        if (cachedObject == null) {
            unmanagedObject = new com.pnla.onroadplus.z_version2.MenuFragments.Units.model.Unit();
            cache.put(realmObject, new RealmObjectProxy.CacheData<RealmModel>(currentDepth, unmanagedObject));
        } else {
            // Reuse cached object or recreate it because it was encountered at a lower depth.
            if (currentDepth >= cachedObject.minDepth) {
                return (com.pnla.onroadplus.z_version2.MenuFragments.Units.model.Unit) cachedObject.object;
            }
            unmanagedObject = (com.pnla.onroadplus.z_version2.MenuFragments.Units.model.Unit) cachedObject.object;
            cachedObject.minDepth = currentDepth;
        }
        com_pnla_onroadplus_z_version2_MenuFragments_Units_model_UnitRealmProxyInterface unmanagedCopy = (com_pnla_onroadplus_z_version2_MenuFragments_Units_model_UnitRealmProxyInterface) unmanagedObject;
        com_pnla_onroadplus_z_version2_MenuFragments_Units_model_UnitRealmProxyInterface realmSource = (com_pnla_onroadplus_z_version2_MenuFragments_Units_model_UnitRealmProxyInterface) realmObject;
    ...
    static com.pnla.onroadplus.z_version2.MenuFragments.Units.model.Unit update(Realm realm, UnitColumnInfo columnInfo, com.pnla.onroadplus.z_version2.MenuFragments.Units.model.Unit realmObject, com.pnla.onroadplus.z_version2.MenuFragments.Units.model.Unit newObject, Map<RealmModel, RealmObjectProxy> cache, Set<ImportFlag> flags) {
        com_pnla_onroadplus_z_version2_MenuFragments_Units_model_UnitRealmProxyInterface realmObjectTarget = (com_pnla_onroadplus_z_version2_MenuFragments_Units_model_UnitRealmProxyInterface) realmObject;
        com_pnla_onroadplus_z_version2_MenuFragments_Units_model_UnitRealmProxyInterface realmObjectSource = (com_pnla_onroadplus_z_version2_MenuFragments_Units_model_UnitRealmProxyInterface) newObject;
        Table table = realm.getTable(com.pnla.onroadplus.z_version2.MenuFragments.Units.model.Unit.class);
        OsObjectBuilder builder = new OsObjectBuilder(table, columnInfo.maxColumnIndexValue, flags);
        builder.addInteger(columnInfo.idIndex, realmObjectSource.realmGet$id());
    ...
    public boolean equals(Object o) {
        ...
        com_pnla_onroadplus_z_version2_MenuFragments_Units_model_UnitRealmProxy aUnit = (com_pnla_onroadplus_z_version2_MenuFragments_Units_model_UnitRealmProxy)o;
