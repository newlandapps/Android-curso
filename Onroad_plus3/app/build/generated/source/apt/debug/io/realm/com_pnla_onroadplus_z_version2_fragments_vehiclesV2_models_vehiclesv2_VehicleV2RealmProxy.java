...
public class com_pnla_onroadplus_z_version2_fragments_vehiclesV2_models_vehiclesv2_VehicleV2RealmProxy extends com.pnla.onroadplus.z_version2.fragments.vehiclesV2.models.vehiclesv2.VehicleV2
    implements RealmObjectProxy, com_pnla_onroadplus_z_version2_fragments_vehiclesV2_models_vehiclesv2_VehicleV2RealmProxyInterface {
    ...
    private ProxyState<com.pnla.onroadplus.z_version2.fragments.vehiclesV2.models.vehiclesv2.VehicleV2> proxyState;

    com_pnla_onroadplus_z_version2_fragments_vehiclesV2_models_vehiclesv2_VehicleV2RealmProxy() {
    ...
    public void realm$injectObjectContext() {
        ...
        this.proxyState = new ProxyState<com.pnla.onroadplus.z_version2.fragments.vehiclesV2.models.vehiclesv2.VehicleV2>(this);
    ...
    @SuppressWarnings("cast")
    public static com.pnla.onroadplus.z_version2.fragments.vehiclesV2.models.vehiclesv2.VehicleV2 createOrUpdateUsingJsonObject(Realm realm, JSONObject json, boolean update)
        throws JSONException {
        final List<String> excludeFields = Collections.<String> emptyList();
        com.pnla.onroadplus.z_version2.fragments.vehiclesV2.models.vehiclesv2.VehicleV2 obj = null;
        if (update) {
            Table table = realm.getTable(com.pnla.onroadplus.z_version2.fragments.vehiclesV2.models.vehiclesv2.VehicleV2.class);
            VehicleV2ColumnInfo columnInfo = (VehicleV2ColumnInfo) realm.getSchema().getColumnInfo(com.pnla.onroadplus.z_version2.fragments.vehiclesV2.models.vehiclesv2.VehicleV2.class);
            ...
            if (rowIndex != Table.NO_MATCH) {
                ...
                try {
                    objectContext.set(realm, table.getUncheckedRow(rowIndex), realm.getSchema().getColumnInfo(com.pnla.onroadplus.z_version2.fragments.vehiclesV2.models.vehiclesv2.VehicleV2.class), false, Collections.<String> emptyList());
                    obj = new io.realm.com_pnla_onroadplus_z_version2_fragments_vehiclesV2_models_vehiclesv2_VehicleV2RealmProxy();
                } finally {
                    objectContext.clear();
                }
            }
        ...
        if (obj == null) {
            if (json.has("cve_vehicle")) {
                if (json.isNull("cve_vehicle")) {
                    obj = (io.realm.com_pnla_onroadplus_z_version2_fragments_vehiclesV2_models_vehiclesv2_VehicleV2RealmProxy) realm.createObjectInternal(com.pnla.onroadplus.z_version2.fragments.vehiclesV2.models.vehiclesv2.VehicleV2.class, null, true, excludeFields);
                } else {
                    obj = (io.realm.com_pnla_onroadplus_z_version2_fragments_vehiclesV2_models_vehiclesv2_VehicleV2RealmProxy) realm.createObjectInternal(com.pnla.onroadplus.z_version2.fragments.vehiclesV2.models.vehiclesv2.VehicleV2.class, json.getInt("cve_vehicle"), true, excludeFields);
                }
            } else {
        ...
        final com_pnla_onroadplus_z_version2_fragments_vehiclesV2_models_vehiclesv2_VehicleV2RealmProxyInterface objProxy = (com_pnla_onroadplus_z_version2_fragments_vehiclesV2_models_vehiclesv2_VehicleV2RealmProxyInterface) obj;
    ...
    public static com.pnla.onroadplus.z_version2.fragments.vehiclesV2.models.vehiclesv2.VehicleV2 createUsingJsonStream(Realm realm, JsonReader reader)
        throws IOException {
        boolean jsonHasPrimaryKey = false;
        final com.pnla.onroadplus.z_version2.fragments.vehiclesV2.models.vehiclesv2.VehicleV2 obj = new com.pnla.onroadplus.z_version2.fragments.vehiclesV2.models.vehiclesv2.VehicleV2();
        final com_pnla_onroadplus_z_version2_fragments_vehiclesV2_models_vehiclesv2_VehicleV2RealmProxyInterface objProxy = (com_pnla_onroadplus_z_version2_fragments_vehiclesV2_models_vehiclesv2_VehicleV2RealmProxyInterface) obj;
        reader.beginObject();
    ...
    private static com_pnla_onroadplus_z_version2_fragments_vehiclesV2_models_vehiclesv2_VehicleV2RealmProxy newProxyInstance(BaseRealm realm, Row row) {
        // Ignore default values to avoid creating uexpected objects from RealmModel/RealmList fields
        final BaseRealm.RealmObjectContext objectContext = BaseRealm.objectContext.get();
        objectContext.set(realm, row, realm.getSchema().getColumnInfo(com.pnla.onroadplus.z_version2.fragments.vehiclesV2.models.vehiclesv2.VehicleV2.class), false, Collections.<String>emptyList());
        io.realm.com_pnla_onroadplus_z_version2_fragments_vehiclesV2_models_vehiclesv2_VehicleV2RealmProxy obj = new io.realm.com_pnla_onroadplus_z_version2_fragments_vehiclesV2_models_vehiclesv2_VehicleV2RealmProxy();
        objectContext.clear();
        return obj;
    }

    public static com.pnla.onroadplus.z_version2.fragments.vehiclesV2.models.vehiclesv2.VehicleV2 copyOrUpdate(Realm realm, VehicleV2ColumnInfo columnInfo, com.pnla.onroadplus.z_version2.fragments.vehiclesV2.models.vehiclesv2.VehicleV2 object, boolean update, Map<RealmModel,RealmObjectProxy> cache, Set<ImportFlag> flags) {
        ...
        if (cachedRealmObject != null) {
            return (com.pnla.onroadplus.z_version2.fragments.vehiclesV2.models.vehiclesv2.VehicleV2) cachedRealmObject;
        }

        com.pnla.onroadplus.z_version2.fragments.vehiclesV2.models.vehiclesv2.VehicleV2 realmObject = null;
        boolean canUpdate = update;
        if (canUpdate) {
            Table table = realm.getTable(com.pnla.onroadplus.z_version2.fragments.vehiclesV2.models.vehiclesv2.VehicleV2.class);
            long pkColumnIndex = columnInfo.cve_vehicleIndex;
            long rowIndex = table.findFirstLong(pkColumnIndex, ((com_pnla_onroadplus_z_version2_fragments_vehiclesV2_models_vehiclesv2_VehicleV2RealmProxyInterface) object).realmGet$cve_vehicle());
            if (rowIndex == Table.NO_MATCH) {
                canUpdate = false;
            } else {
                try {
                    objectContext.set(realm, table.getUncheckedRow(rowIndex), columnInfo, false, Collections.<String> emptyList());
                    realmObject = new io.realm.com_pnla_onroadplus_z_version2_fragments_vehiclesV2_models_vehiclesv2_VehicleV2RealmProxy();
    ...
    public static com.pnla.onroadplus.z_version2.fragments.vehiclesV2.models.vehiclesv2.VehicleV2 copy(Realm realm, VehicleV2ColumnInfo columnInfo, com.pnla.onroadplus.z_version2.fragments.vehiclesV2.models.vehiclesv2.VehicleV2 newObject, boolean update, Map<RealmModel,RealmObjectProxy> cache, Set<ImportFlag> flags) {
        RealmObjectProxy cachedRealmObject = cache.get(newObject);
        if (cachedRealmObject != null) {
            return (com.pnla.onroadplus.z_version2.fragments.vehiclesV2.models.vehiclesv2.VehicleV2) cachedRealmObject;
        }

        com_pnla_onroadplus_z_version2_fragments_vehiclesV2_models_vehiclesv2_VehicleV2RealmProxyInterface realmObjectSource = (com_pnla_onroadplus_z_version2_fragments_vehiclesV2_models_vehiclesv2_VehicleV2RealmProxyInterface) newObject;
        ...
        io.realm.com_pnla_onroadplus_z_version2_fragments_vehiclesV2_models_vehiclesv2_VehicleV2RealmProxy realmObjectCopy = newProxyInstance(realm, row);
        cache.put(newObject, realmObjectCopy);

        return realmObjectCopy;
    }

    public static long insert(Realm realm, com.pnla.onroadplus.z_version2.fragments.vehiclesV2.models.vehiclesv2.VehicleV2 object, Map<RealmModel,Long> cache) {
        ...
        long pkColumnIndex = columnInfo.cve_vehicleIndex;
        long rowIndex = Table.NO_MATCH;
        Object primaryKeyValue = ((com_pnla_onroadplus_z_version2_fragments_vehiclesV2_models_vehiclesv2_VehicleV2RealmProxyInterface) object).realmGet$cve_vehicle();
        if (primaryKeyValue != null) {
            rowIndex = Table.nativeFindFirstInt(tableNativePtr, pkColumnIndex, ((com_pnla_onroadplus_z_version2_fragments_vehiclesV2_models_vehiclesv2_VehicleV2RealmProxyInterface) object).realmGet$cve_vehicle());
        }
        if (rowIndex == Table.NO_MATCH) {
            rowIndex = OsObject.createRowWithPrimaryKey(table, pkColumnIndex, ((com_pnla_onroadplus_z_version2_fragments_vehiclesV2_models_vehiclesv2_VehicleV2RealmProxyInterface) object).realmGet$cve_vehicle());
        } else {
            Table.throwDuplicatePrimaryKeyException(primaryKeyValue);
        }
        cache.put(object, rowIndex);
        String realmGet$userVehicle = ((com_pnla_onroadplus_z_version2_fragments_vehiclesV2_models_vehiclesv2_VehicleV2RealmProxyInterface) object).realmGet$userVehicle();
        ...
        String realmGet$vehicle_name = ((com_pnla_onroadplus_z_version2_fragments_vehiclesV2_models_vehiclesv2_VehicleV2RealmProxyInterface) object).realmGet$vehicle_name();
        ...
        String realmGet$vehicle_image = ((com_pnla_onroadplus_z_version2_fragments_vehiclesV2_models_vehiclesv2_VehicleV2RealmProxyInterface) object).realmGet$vehicle_image();
        ...
        Table.nativeSetDouble(tableNativePtr, columnInfo.latitudeIndex, rowIndex, ((com_pnla_onroadplus_z_version2_fragments_vehiclesV2_models_vehiclesv2_VehicleV2RealmProxyInterface) object).realmGet$latitude(), false);
        Table.nativeSetDouble(tableNativePtr, columnInfo.longitudeIndex, rowIndex, ((com_pnla_onroadplus_z_version2_fragments_vehiclesV2_models_vehiclesv2_VehicleV2RealmProxyInterface) object).realmGet$longitude(), false);
        Table.nativeSetBoolean(tableNativePtr, columnInfo.selectedIndex, rowIndex, ((com_pnla_onroadplus_z_version2_fragments_vehiclesV2_models_vehiclesv2_VehicleV2RealmProxyInterface) object).realmGet$selected(), false);
        Table.nativeSetLong(tableNativePtr, columnInfo.positionItemIndex, rowIndex, ((com_pnla_onroadplus_z_version2_fragments_vehiclesV2_models_vehiclesv2_VehicleV2RealmProxyInterface) object).realmGet$positionItem(), false);
        return rowIndex;
    }
    ...
    public static void insert(Realm realm, Iterator<? extends RealmModel> objects, Map<RealmModel,Long> cache) {
        ...
        VehicleV2ColumnInfo columnInfo = (VehicleV2ColumnInfo) realm.getSchema().getColumnInfo(com.pnla.onroadplus.z_version2.fragments.vehiclesV2.models.vehiclesv2.VehicleV2.class);
        long pkColumnIndex = columnInfo.cve_vehicleIndex;
        com.pnla.onroadplus.z_version2.fragments.vehiclesV2.models.vehiclesv2.VehicleV2 object = null;
        while (objects.hasNext()) {
            object = (com.pnla.onroadplus.z_version2.fragments.vehiclesV2.models.vehiclesv2.VehicleV2) objects.next();
    ...
    public static long insertOrUpdate(Realm realm, com.pnla.onroadplus.z_version2.fragments.vehiclesV2.models.vehiclesv2.VehicleV2 object, Map<RealmModel,Long> cache) {
        if (object instanceof RealmObjectProxy && ((RealmObjectProxy) object).realmGet$proxyState().getRealm$realm() != null && ((RealmObjectProxy) object).realmGet$proxyState().getRealm$realm().getPath().equals(realm.getPath())) {
            return ((RealmObjectProxy) object).realmGet$proxyState().getRow$realm().getIndex();
        }
        Table table = realm.getTable(com.pnla.onroadplus.z_version2.fragments.vehiclesV2.models.vehiclesv2.VehicleV2.class);
    ...
    public static com.pnla.onroadplus.z_version2.fragments.vehiclesV2.models.vehiclesv2.VehicleV2 createDetachedCopy(com.pnla.onroadplus.z_version2.fragments.vehiclesV2.models.vehiclesv2.VehicleV2 realmObject, int currentDepth, int maxDepth, Map<RealmModel, CacheData<RealmModel>> cache) {
        if (currentDepth > maxDepth || realmObject == null) {
            return null;
        }
        CacheData<RealmModel> cachedObject = cache.get(realmObject);
        com.pnla.onroadplus.z_version2.fragments.vehiclesV2.models.vehiclesv2.VehicleV2 unmanagedObject;
        if (cachedObject == null) {
            unmanagedObject = new com.pnla.onroadplus.z_version2.fragments.vehiclesV2.models.vehiclesv2.VehicleV2();
            cache.put(realmObject, new RealmObjectProxy.CacheData<RealmModel>(currentDepth, unmanagedObject));
        } else {
            // Reuse cached object or recreate it because it was encountered at a lower depth.
            if (currentDepth >= cachedObject.minDepth) {
                return (com.pnla.onroadplus.z_version2.fragments.vehiclesV2.models.vehiclesv2.VehicleV2) cachedObject.object;
            }
            unmanagedObject = (com.pnla.onroadplus.z_version2.fragments.vehiclesV2.models.vehiclesv2.VehicleV2) cachedObject.object;
            cachedObject.minDepth = currentDepth;
        }
        com_pnla_onroadplus_z_version2_fragments_vehiclesV2_models_vehiclesv2_VehicleV2RealmProxyInterface unmanagedCopy = (com_pnla_onroadplus_z_version2_fragments_vehiclesV2_models_vehiclesv2_VehicleV2RealmProxyInterface) unmanagedObject;
        com_pnla_onroadplus_z_version2_fragments_vehiclesV2_models_vehiclesv2_VehicleV2RealmProxyInterface realmSource = (com_pnla_onroadplus_z_version2_fragments_vehiclesV2_models_vehiclesv2_VehicleV2RealmProxyInterface) realmObject;
    ...
    static com.pnla.onroadplus.z_version2.fragments.vehiclesV2.models.vehiclesv2.VehicleV2 update(Realm realm, VehicleV2ColumnInfo columnInfo, com.pnla.onroadplus.z_version2.fragments.vehiclesV2.models.vehiclesv2.VehicleV2 realmObject, com.pnla.onroadplus.z_version2.fragments.vehiclesV2.models.vehiclesv2.VehicleV2 newObject, Map<RealmModel, RealmObjectProxy> cache, Set<ImportFlag> flags) {
        com_pnla_onroadplus_z_version2_fragments_vehiclesV2_models_vehiclesv2_VehicleV2RealmProxyInterface realmObjectTarget = (com_pnla_onroadplus_z_version2_fragments_vehiclesV2_models_vehiclesv2_VehicleV2RealmProxyInterface) realmObject;
        com_pnla_onroadplus_z_version2_fragments_vehiclesV2_models_vehiclesv2_VehicleV2RealmProxyInterface realmObjectSource = (com_pnla_onroadplus_z_version2_fragments_vehiclesV2_models_vehiclesv2_VehicleV2RealmProxyInterface) newObject;
        Table table = realm.getTable(com.pnla.onroadplus.z_version2.fragments.vehiclesV2.models.vehiclesv2.VehicleV2.class);
        OsObjectBuilder builder = new OsObjectBuilder(table, columnInfo.maxColumnIndexValue, flags);
        builder.addInteger(columnInfo.cve_vehicleIndex, realmObjectSource.realmGet$cve_vehicle());
    ...
    public boolean equals(Object o) {
        ...
        com_pnla_onroadplus_z_version2_fragments_vehiclesV2_models_vehiclesv2_VehicleV2RealmProxy aVehicleV2 = (com_pnla_onroadplus_z_version2_fragments_vehiclesV2_models_vehiclesv2_VehicleV2RealmProxy)o;
