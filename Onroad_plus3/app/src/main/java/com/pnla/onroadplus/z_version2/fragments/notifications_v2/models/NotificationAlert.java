...
public class NotificationAlert {
     ...
     * @param heading
     */
    public NotificationAlert(int alert_lat, int alert_lon, String alert_text, int cve_notification, int cve_vehicle, String heading, String msg_type, int origin_adm, String send_time) {
        super();
