...
public class TemporalTrackingDBHelper {
    public Realm realm;
    public TemporalTrackingDBHelper(Realm realm) {
        this.realm = realm;
    }
    ...
    public static void deleteDatabase(){
        Realm realm = Realm.getDefaultInstance();
        realm.beginTransaction();
        RealmResults<VehicleTracking> songRealmResults = realm.where(VehicleTracking.class).findAll();
    ...
    public static List<VehicleTracking> readVehicleList(){
        Realm realm = Realm.getDefaultInstance();
        RealmResults<VehicleTracking> realmresults = realm.where(VehicleTracking.class).findAll();
