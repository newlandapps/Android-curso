...
public class AdapterNotificationsV2 extends RecyclerView.Adapter<AdapterNotificationsV2.ViewHolder> {
    ...
    public AdapterNotificationsV2(Context context, List<NotificationV2OnRoad> notifications) {
    ...
    public interface OnClickNotificationListener {
        void onClickNotification(NotificationV2OnRoad notification);
    }
