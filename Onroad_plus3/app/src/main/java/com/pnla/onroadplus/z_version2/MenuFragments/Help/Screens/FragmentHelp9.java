...
public class FragmentHelp9 extends Fragment {

    public static final String TAG = FragmentHelp9.class.getSimpleName();
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        initViews(view);
    //    setFonts();
        Glide.with(getContext()).load(R.drawable.help_9).into(imgvContactHelp);
        return view;
    }
