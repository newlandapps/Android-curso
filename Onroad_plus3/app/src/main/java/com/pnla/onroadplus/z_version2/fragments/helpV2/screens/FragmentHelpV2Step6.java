...
public class FragmentHelpV2Step6 extends Fragment {

    public static final String TAG = FragmentHelpV2Step6.class.getSimpleName();
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        initViews(view);
        setFonts();
        Glide.with(getContext()).load(R.drawable.commands).into(imgvCommandsHelp);
        return view;
    }
