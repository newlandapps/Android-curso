...
public class VehicleV2 extends RealmObject implements Parcelable {
    ...
    public VehicleV2(String userVehicle, String vehicle_name, String vehicle_image, double latitude,
    ...
    public static final Creator<VehicleV2> CREATOR = new Creator<VehicleV2>() {
        @Override
        public VehicleV2 createFromParcel(Parcel in) {
            return new VehicleV2(in);
        }

        @Override
        public VehicleV2[] newArray(int size) {
            return new VehicleV2[size];
        }
    };
