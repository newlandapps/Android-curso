...
public class VehiclesUtils {
    public static List<Vehicles> setUserSelectedPositionAndImageToEveryVehicle(List<Vehicles> vehicles, Context context) {
    ...
    public static List<Vehicles> getSelectedVehicles(List<Vehicles> vehiclesWebService, List<Vehicles> realmVehicles) {
    ...
    public static List<Groups> setUserSelectedPositionToEveryGroup(List<Groups> groups, Context context) {
        SharedPreferences preferences = context.getSharedPreferences(GeneralConstantsV2.CREDENTIALS_PREFERENCES, Context.MODE_PRIVATE);
        String user = preferences.getString(GeneralConstantsV2.USER_PREFERENCES, null);
        for (int i = 0; i < groups.size(); i++) {
            groups.get(i).setUserGroup(user);       /**Seteamos usuario*/
    ...
    public static List<Groups> getSelectedGroups(List<Groups> groupsWebService, List<Groups> realmGroups) {
