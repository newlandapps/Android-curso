...
public class FragmentHelp1 extends Fragment {
    ...
    public static final String TAG = FragmentHelp1.class.getSimpleName();
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        initViews(view);
//        setFonts();
        Glide.with(getContext()).load(R.drawable.help_1).into(imgvTrackImage);
        return view;
    }
    ...
    /*private void setFonts() {
        ...
        txvTrackTitle.setTypeface(latoBoldTypeface);
