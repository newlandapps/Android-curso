...
public class FragmentHelp7 extends Fragment {

    public static final String TAG = FragmentHelp7.class.getSimpleName();
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        initViews(view);
      //  setFonts();
        Glide.with(getContext()).load(R.drawable.help_7).into(imgvNotificationHelp);
        return view;
    }
