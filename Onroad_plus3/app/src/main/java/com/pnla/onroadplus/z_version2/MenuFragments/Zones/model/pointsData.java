...
public class pointsData {
    ...
    @Expose
    private List<pointsInterest> interests = null;

    public pointsData(int cveLayer,String descLayer,String lats,String lngs,List<pointsInterest> interests)
    {
        //super();
    ...
    public List<pointsInterest> getInterests() {
        return interests;
    }

    public void setInterests(List<pointsInterest> interests) {
        this.interests = interests;
    }
