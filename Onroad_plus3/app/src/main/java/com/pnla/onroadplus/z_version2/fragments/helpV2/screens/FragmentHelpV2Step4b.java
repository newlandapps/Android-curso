...
public class FragmentHelpV2Step4b extends Fragment {

    public static final String TAG = FragmentHelpV2Step4b.class.getSimpleName();
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View view = inflater.inflate(R.layout.fragment_help_step_4b, container, false);
        initViews(view);
        setFonts();
        return view;
    }
